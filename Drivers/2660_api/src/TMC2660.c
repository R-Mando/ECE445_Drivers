...
uint8_t tmc2660_reset(TMC2660TypeDef *TMC2660, ConfigurationTypeDef *TMC2660_config)
{
	...
	tmc2660_writeInt(0, REG_DRVCONF,  TMC2660->registerResetState[REG_DRVCONF]);
	tmc2660_writeInt(0, REG_DRVCTRL,  TMC2660->registerResetState[REG_DRVCTRL]);
	tmc2660_writeInt(0, REG_CHOPCONF, TMC2660->registerResetState[REG_CHOPCONF]);
	tmc2660_writeInt(0, REG_SMARTEN,  TMC2660->registerResetState[REG_SMARTEN]);
	tmc2660_writeInt(0, REG_SGCSCONF, TMC2660->registerResetState[REG_SGCSCONF]);
...
{
	tmc2660_writeInt(0, REG_DRVCONF,  TMC2660_config->shadowRegister[REG_DRVCONF | TMC2660_WRITE_BIT]);
	tmc2660_writeInt(0, REG_DRVCTRL,  TMC2660_config->shadowRegister[REG_DRVCTRL | TMC2660_WRITE_BIT]);
	tmc2660_writeInt(0, REG_CHOPCONF, TMC2660_config->shadowRegister[REG_CHOPCONF | TMC2660_WRITE_BIT]);
	tmc2660_writeInt(0, REG_SMARTEN,  TMC2660_config->shadowRegister[REG_SMARTEN | TMC2660_WRITE_BIT]);
	tmc2660_writeInt(0, REG_SGCSCONF, TMC2660_config->shadowRegister[REG_SGCSCONF | TMC2660_WRITE_BIT]);
